...
function TablaEjerciciosHead (props) {
  const {
    // onSelectAllClick,
    order,
    orderBy,
...
function TablaEjerciciosToolbar (props) {
...
TablaEjerciciosToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
      ...
      {data && data.length > 0 &&
        <Box sx={{ width: '100%' }}>
          <Paper sx={{ width: '100%', mb: 2 }}>
            <TablaEjerciciosToolbar numSelected={selected.length} idSelected={Number(selected[0]) || 0} />
            <TableContainer>
              <Table
                sx={{ minWidth: 750 }}
                    ...
                    .map((row, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align='left'>{row.nombreEjercicio}</TableCell>
