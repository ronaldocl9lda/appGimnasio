...
function TableRutinasHead (props) {
  const {
    // onSelectAllClick,
    order,
    orderBy,
...
export default function TableRutinas () {
  ...
  const handleClick = (event, id) => {
    ...
    if (selectedIndex === -1) {
      // Si el ID seleccionado no está en el array de elementos seleccionados, agrégalo al array newSelected.
      newSelected = newSelected.concat(selected, id)
    } else if (selectedIndex === 0) {
      // Si el ID seleccionado es el primer elemento del array de elementos seleccionados, remuévelo del array newSelected.
      newSelected = newSelected.concat(selected.slice(1))
    } else if (selectedIndex === selected.length - 1) {
      // Si el ID seleccionado es el último elemento del array de elementos seleccionados, remuévelo del array newSelected.
      newSelected = newSelected.concat(selected.slice(0, -1))
    } else if (selectedIndex > 0) {
      // Si el ID seleccionado está en medio del array de elementos seleccionados, remuévelo del array newSelected.
      newSelected = newSelected.concat(
        selected.slice(0, selectedIndex),
        selected.slice(selectedIndex + 1)
      )
