...
function TablaActividadesHead (props) {
  const {
    // onSelectAllClick,
    order,
    orderBy,
...
TablaActividadesHead.propTypes = {
...
function TablaActividadesToolbar (props) {
...
TablaActividadesToolbar.propTypes = {
  numSelected: PropTypes.number.isRequired,
      ...
      {data && data.length > 0 &&
        <Box sx={{ width: '100%' }}>
          <Paper sx={{ width: '100%', mb: 2 }}>
            <TablaActividadesToolbar numSelected={selected.length} idSelected={Number(selected[0]) || 0} />
            <TableContainer>
              <Table
                sx={{ minWidth: 750 }}
